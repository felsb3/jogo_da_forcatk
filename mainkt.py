...
class Forca(Frame):
    ...
    def inicio_jogo(self):
        ...
        self.dica_mostra['text'] = funcoes.dica_inicial()
    ...
    def create_widgets(self):
        ...
        self.letraA = Button(self.frame1, font=("Helvetica", 12), text="A", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("AÁÂÃ"))
        self.letraA.grid(row=0, column=0, sticky="NWNESWSE")

        self.letraB = Button(self.frame1, font=("Helvetica", 12), text="B", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("B"))
        self.letraB.grid(row=0, column=1, sticky="NWNESWSE")

        self.letraC = Button(self.frame1, font=("Helvetica", 12), text="C", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("CÇ"))
        self.letraC.grid(row=0, column=2, sticky="NWNESWSE")

        self.letraD = Button(self.frame1, font=("Helvetica", 12), text="D", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("D"))
        self.letraD.grid(row=0, column=3, sticky="NWNESWSE")

        self.letraE = Button(self.frame1, font=("Helvetica", 12), text="E", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("EÉÊ"))
        self.letraE.grid(row=0, column=4, sticky="NWNESWSE")

        self.letraF = Button(self.frame1, font=("Helvetica", 12), text="F", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("F"))
        self.letraF.grid(row=0, column=5, sticky="NWNESWSE")

        self.letraG = Button(self.frame1, font=("Helvetica", 12), text="G", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("G"))
        self.letraG.grid(row=0, column=6, sticky="NWNESWSE")

        # linha 1
        self.letraH = Button(self.frame1, font=("Helvetica", 12), text="H", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("H"))
        self.letraH.grid(row=1, column=0, sticky="NWNESWSE")

        self.letraI = Button(self.frame1, font=("Helvetica", 12), text="I", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("IÍ"))
        self.letraI.grid(row=1, column=1, sticky="NWNESWSE")

        self.letraJ = Button(self.frame1, font=("Helvetica", 12), text="J", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("J"))
        self.letraJ.grid(row=1, column=2, sticky="NWNESWSE")

        self.letraK = Button(self.frame1, font=("Helvetica", 12), text="K", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("K"))
        self.letraK.grid(row=1, column=3, sticky="NWNESWSE")

        self.letraL = Button(self.frame1, font=("Helvetica", 12), text="L", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("L"))
        self.letraL.grid(row=1, column=4, sticky="NWNESWSE")

        self.letraM = Button(self.frame1, font=("Helvetica", 12), text="M", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("M"))
        self.letraM.grid(row=1, column=5, sticky="NWNESWSE")

        self.letraN = Button(self.frame1, font=("Helvetica", 12), text="N", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("N"))
        self.letraN.grid(row=1, column=6, sticky="NWNESWSE")

        # linha 2
        self.letraO = Button(self.frame1, font=("Helvetica", 12), text="O", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("OÓÔ"))
        self.letraO.grid(row=2, column=0, sticky="NWNESWSE")

        self.letraP = Button(self.frame1, font=("Helvetica", 12), text="P", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("P"))
        self.letraP.grid(row=2, column=1, sticky="NWNESWSE")

        self.letraQ = Button(self.frame1, font=("Helvetica", 12), text="Q", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("Q"))
        self.letraQ.grid(row=2, column=2, sticky="NWNESWSE")

        self.letraR = Button(self.frame1, font=("Helvetica", 12), text="R", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("R"))
        self.letraR.grid(row=2, column=3, sticky="NWNESWSE")

        self.letraS = Button(self.frame1, font=("Helvetica", 12), text="S", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("S"))
        self.letraS.grid(row=2, column=4, sticky="NWNESWSE")

        self.letraT = Button(self.frame1, font=("Helvetica", 12), text="T", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("T"))
        self.letraT.grid(row=2, column=5, sticky="NWNESWSE")

        self.letraU = Button(self.frame1, font=("Helvetica", 12), text="U", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("UÚ"))
        self.letraU.grid(row=2, column=6, sticky="NWNESWSE")

        # linha 3
        self.letraV = Button(self.frame1, font=("Helvetica", 12), text="V", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("V"))
        self.letraV.grid(row=3, column=0, sticky="NWNESWSE")

        self.letraW = Button(self.frame1, font=("Helvetica", 12), text="W", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("W"))
        self.letraW.grid(row=3, column=1, sticky="NWNESWSE")

        self.letraX = Button(self.frame1, font=("Helvetica", 12), text="X", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("X"))
        self.letraX.grid(row=3, column=2, sticky="NWNESWSE")

        self.letraY = Button(self.frame1, font=("Helvetica", 12), text="Y", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("Y"))
        self.letraY.grid(row=3, column=3, sticky="NWNESWSE")

        self.letraZ = Button(self.frame1, font=("Helvetica", 12), text="Z", borderwidth=1, padx=16, pady=16,
                             command=lambda: self.set_letras_digitadas("Z"))
        self.letraZ.grid(row=3, column=4, sticky="NWNESWSE")

        self.reiniciar = Button(self.frame1, font=("Helvetica", 12), text="Reiniciar", borderwidth=1, padx=16, pady=16,
                                command=self.inicio_jogo)
        ...
        # Dica
        self.frame5 = Frame(self, relief=SUNKEN, borderwidth=8)
        self.frame5.grid(row=6, sticky="NWNESWSE")

        self.dica_label = Label(self.frame5, text="DICA", font=("Helvetica", 12))
        self.dica_label.grid(row=0, columnspan=6)

        self.dica_mostra = Label(self.frame5, text="", font=("Helvetica", 12))
        self.dica_mostra.grid(row=1)
        ...
        self.palavra_secreta_titulo = Label(self.frame4, font=("Helvetica", 12), text="PALAVRA SECRETA.", padx=10,
                                            pady=10)
